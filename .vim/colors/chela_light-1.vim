...
let g:colors_name="chela_light-1"


"Syntax Groups =============================================

hi comment      guibg=#fafafa   guifg=DarkGreen   gui=none

hi constant     guibg=#fafafa   guifg=VioletRed4   gui=none

hi identifier   guibg=#fafafa   guifg=blue3   gui=none

hi statement    guibg=#fafafa   guifg=blue3   gui=none

hi preproc      guibg=#fafafa   guifg=blue3   gui=none
hi precondit    guibg=#fafafa   guifg=#cc00cc   gui=none

hi type         guibg=#fafafa   guifg=blue3   gui=none
