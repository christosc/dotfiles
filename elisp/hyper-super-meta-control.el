...
(global-set-key (kbd "C-χ") 'Control-X-prefix)
(define-key ctl-x-map (kbd "C-σ") 'save-buffer)
(define-key ctl-x-map (kbd "σ") 'save-some-buffers)
;;(global-set-key (kbd "M-s") 'save-buffer)
;;(global-set-key (kbd "M-σ") 'save-buffer)
(define-key ctl-x-map (kbd "C-ς") 'write-file)
...
(define-key ctl-x-map (kbd "β") 'switch-to-buffer)
(define-key ctl-x-map (kbd "C-β") 'list-buffer)
...
(define-key ctl-x-map (kbd "θ") 'undo)
(global-set-key (kbd "C-῟") 'undo)
(define-key ctl-x-map (kbd "κ") 'kill-buffer)
(define-key ctl-x-map (kbd "ο") 'other-window)
(define-key ctl-x-map (kbd "C-ρ") 'recentf-open-files)
(define-key ctl-x-map (kbd "C-ψ") 'save-buffers-kill-terminal)
(global-set-key (kbd "C-γ") 'keyboard-quit)
(define-key ctl-x-map (kbd "ρ τ") 'string-rectangle)
